source("~/exercism/r/diamond/diamond.R")
library(testthat)
...
test_that("Smallest non-degenerate case with odd diamond side length", {
  expect_equal(diamond("C"), paste(sep = "\n",
                                  "  A  ",
                                  " B B ",
                                  "C   C",
                                  " B B ",
...
test_that("Smallest non-degenerate case with even diamond side length", {
  expect_equal(diamond("D"), paste(sep = "\n",
                                  "   A   ",
                                  "  B B  ",
                                  " C   C ",
                                  "D     D",
...
test_that("Largest possible diamond", {
  expect_equal(diamond("Z"), paste(sep = "\n",
                 "                         A                         ",
                 "                        B B                        ",
                 "                       C   C                       ",
                 "                      D     D                      ",
...
message("All tests passed for exercise: diamonds")
